            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user4') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user4/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user4') {
                    ...
                    openshift.tag("user4/gateway-canary:latest", "user4/gateway:latest")
